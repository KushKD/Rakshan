...
public class RakshamPermissionResponse {
     ...
     */
    protected RakshamPermissionResponse(Map<String, Integer> perms, ArrayList<String> userPerm,Activity activity,int requestId) {
        this.mPerms = perms;
