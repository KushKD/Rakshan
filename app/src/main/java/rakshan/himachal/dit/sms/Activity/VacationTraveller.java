...
public class VacationTraveller extends FragmentActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vacation_traveller);
            ...
            public void onClick(View v) {
                ...
                if(tv_latitude.getText().length()!= 0 && tv_longitude.getText().length()!=0){
                  ...
                  //  startActivity(i);
                    ...
                    CD.showDialog(VacationTraveller.this,"Please go to the settings and  enable your GPS Location.");
                }
            }
        });
    }
